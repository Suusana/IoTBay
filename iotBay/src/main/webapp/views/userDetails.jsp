...
<div class="welcome-card">
    ...
    <%
        if (customer != null) {
            String customerName = customer.getFirstName() != null ? Utils.capitaliseFirst(customer.getFirstName()) : "Guest";
            String customerEmail = customer.getEmail() != null ? customer.getEmail() : "guest@example.com";
    %>
    <h1>Welcome, <%= customerName %>!</h1>
    <p>Your email: <strong><%= customerEmail %></strong></p>
    <p class="description">
    ...
    %>
    <h1>Welcome, <%=staff.getStaffName() != null ? staff.getStaffName() : "Staff"%>!</h1>
